        ...
        return {
            ...
            scores: {
                additions: {
                		...
                		numbers: nNumber,
                		symbols: nSymbol,
                    middleNumbersOrSymbols: nMidChar,
                		requirements: nRequirements
                },
                deductions: {
                		lettersOnly: nAlphasOnly,
                		numbersOnly: nNumbersOnly,
                		repeatCharacters: nRepChar,
                		consecutiveUpperCase: nConsecAlphaUC,
                		consecutiveLowerCase: nConsecAlphaLC,
                		consecutiveNumbers: nConsecNumber,
                		sequentialLetters: nSeqAlpha,
                		sequentialNumbers: nSeqNumber,
                		sequentialSymbols: nSeqSymbol
                }
            }
        };
    } else {
